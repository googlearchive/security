  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    SubListIterable: {
      ...
      elementAt$1: function(_, index) {
        var realIndex = C.JSInt_methods.$add(this.get$_startIndex(), index);
        if (typeof index !== "number")
          return index.$lt();
    ...
    ReversedListIterable: {
      ...
      elementAt$1: function(_, index) {
        ...
        t1 = this._source;
        t2 = J.getInterceptor$asx(t1);
        return H.assertSubtypeOfRuntimeType(t2.elementAt$1(t1, C.JSInt_methods.$sub(t2.get$length(t1) - 1, index)), H.getTypeArgumentByIndex(this, 0));
      }
    },
    Symbol: {
    ...
    SetMixin: {
      ...
      elementAt$1: function(_, index) {
        ...
        for (t1 = new P._LinkedHashSetIterator(this, this._collection$_modifications, null, null, [null]), t1._collection$_cell = this._collection$_first, H.assertSubtype(t1, "$isIterator", this.$ti, "$asIterator"), t2 = H.getTypeArgumentByIndex(t1, 0), t3 = H.getTypeArgumentByIndex(this, 0), elementIndex = 0; t1.moveNext$0();) {
    ...
    HtmlElement: {
      "^": "Element;",
      $isHtmlElement: 1,
      "%": "HTMLBRElement|HTMLButtonElement|HTMLContentElement|HTMLDListElement|HTMLDataListElement|HTMLDetailsElement|HTMLDialogElement|HTMLDirectoryElement|HTMLEmbedElement|HTMLFieldSetElement|HTMLFontElement|HTMLFrameElement|HTMLHRElement|HTMLHeadingElement|HTMLHtmlElement|HTMLKeygenElement|HTMLLIElement|HTMLLabelElement|HTMLLegendElement|HTMLLinkElement|HTMLMapElement|HTMLMarqueeElement|HTMLMenuElement|HTMLMenuItemElement|HTMLMetaElement|HTMLMeterElement|HTMLModElement|HTMLOListElement|HTMLObjectElement|HTMLOptGroupElement|HTMLOptionElement|HTMLOutputElement|HTMLParagraphElement|HTMLParamElement|HTMLPictureElement|HTMLPreElement|HTMLProgressElement|HTMLQuoteElement|HTMLScriptElement|HTMLShadowElement|HTMLSlotElement|HTMLSourceElement|HTMLSpanElement|HTMLTableCaptionElement|HTMLTableCellElement|HTMLTableColElement|HTMLTableDataCellElement|HTMLTableHeaderCellElement|HTMLTextAreaElement|HTMLTitleElement|HTMLTrackElement|HTMLUListElement|HTMLUnknownElement;HTMLElement"
    },
    AnchorElement: {
      "^": "HtmlElement;",
      toString$0: function(receiver) {
